          ...
          <section className="py-20 flex flex-col items-center text-center">
            <div className="max-w-3xl mx-auto space-y-6">
              ...
              <div className="flex flex-wrap gap-4 justify-center mt-8">
                ...
                <a
                  href="https://drive.google.com/file/d/1zvL2d3uFEhdhCk-tuPwsVKIR3h2pkvvb/view?usp=drive_link"
                  target="_blank"
                ...
                <div>
                  ...
                  <div className="mt-4">
                    <TimelineItem
                      ...
                      organization="Centre for Integrative Omics Data Science"
                      description="Develop and deploy open-source web applications, RESTful APIs, and AI-powered systems for multi-omics data analysis, visualization, and autonomous data mining using LLMs"
                    />
                    <TimelineItem
                      year="2019 - 2021"
                      title="Freelance Web Developer"
                      organization="Treasure Gifts"
                      description="Designed, Design, develop, and deploy a comprehensive e-commerce platform specializing in a diverse range of gift collections and customized gifts"
                    />
                    <TimelineItem
                      year="2018 - 2019"
                      title="Co-Founder"
                      organization="I.N fruit-Mart E-Commerce"
                      description="Co-founded and managed an e-commerce platform specializing in fresh fruits and vegetables, overseeing operations, logistics, and customer service."
                    />
                    <TimelineItem
                      year="2016 - 2017"
                ...
                <div>
                  ...
                  <div className="mt-4">
                    <TimelineItem
                      ...
                      organization="Vivekananda college of engineering and technology"
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="flex flex-col md:flex-row gap-8 items-start">
                <div className="space-y-6 flex-1">
                  ...
                  <div className="space-y-4">
                    <a
                      href="mailto:m.nisar.dev@gmail.com"
                    ...
                    >
                      ...
                      <span>m.nisar.dev@gmail.com</span>
                    </a>
                    <a
                      href="https://github.com/Mn-Nisar"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 hover:underline"
                    >
                      ...
                      <span>github.com/Mn-Nisar</span>
                    </a>
                    <a
                      href="https://linkedin.com/in/mn-nisar"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 hover:underline"
                    >
                      ...
                      <span>linkedin.com/in/mn-nisar</span>
                    </a>
                  </div>
                </div>
